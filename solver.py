...
from print import print_solution1,print_solution2
...
if __name__ == '__main__':
	...
	if routing.status() == 1 and assignment:
		...
		# Print the solution
		best_score = None
		# best_score = print_solution1(data, routing, manager, assignment)
		best_score = print_solution2(data, manager, routing, assignment)
